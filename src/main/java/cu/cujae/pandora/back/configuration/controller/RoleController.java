...
public class RoleController {
	...
	@DeleteMapping("/deleteLdapRole/{id}")
	...
	public ResponseEntity<Object> updateLdapRole(@PathVariable("id") Long id, @RequestBody Role role){
		Map<String, Object> map= new HashMap<String, Object>();
		try {
			Role r = roleService.getLdapRoleById(id);
			r.setRoleName(role.getRoleName());
			
			Role roleUpdated = roleService.updateLdapRole(r);
